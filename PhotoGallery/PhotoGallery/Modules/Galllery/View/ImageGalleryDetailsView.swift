...
struct ImageGalleryDetailsView: View {
    let cellData: Item
    ...
    private var shareButton: some View {
        ...
        .sheet(isPresented: $isSharing, content: {
            ImageShareView(activityItems: [URL(string: cellData.media.m) as Any, cellData.title])
        })
    }
}

#Preview {
    ImageGalleryDetailsView(cellData: Item(title: "Horned Lark", link: "https://www.flickr.com/photos/amketter/53469306909/", media: Media(m: "https://live.staticflickr.com/65535/53469340586_41dbf5e79c_m.jpg"), dateTaken: "", description: "", published: "", author: "nobody@flickr.com", authorId: "", tags: ""), namespace: Namespace().wrappedValue)
}
